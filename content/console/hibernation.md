...
![The namespace table on the Hibernation page]({{ screenshot: hibernation-table }})
...
![The Sleep drawer in By Labels mode]({{ screenshot: sleep-by-labels }})
...
![The Sleep drawer in By Namespaces mode]({{ screenshot: sleep-by-name-selection }})
...
![The Hibernate drawer in By Labels mode]({{ screenshot: hibernate-by-labels }})

Hibernate Mode can also be applied to an explicit set of namespaces using **By Namespaces**.

![The Hibernate drawer in By Namespaces mode]({{ screenshot: hibernate-by-name-selection }})
...
![The hibernation schedules of a tenant]({{ screenshot: manage-hibernation-schedules }})
...
![The Create New tab of the schedule drawer]({{ screenshot: create-hibernation-schedule }})
...
![The interval popup in the schedule drawer]({{ screenshot: create-interval }})
