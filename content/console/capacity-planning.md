...
![The Add Node Filter drawer]({{ screenshot: add-node-filter }})
...
![The Node Filter table on the Capacity Planning page]({{ screenshot: node-filtering-capacity-planning }})
...
![Capacity Planning with a node filter applied]({{ screenshot: node-filtering-capacity-planning-selected }})
...
![The quota request and cluster capacity charts]({{ screenshot: capacity-planning }})
...
![The Node Capacity table on the Capacity Planning page]({{ screenshot: worker-pool }})
...
![The tenant request table on the Capacity Planning page]({{ screenshot: request-details }})
