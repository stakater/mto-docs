...
![The Template Instances page]({{ screenshot: template-instances }})
...
![A Template Instance detail page]({{ screenshot: template-instance-details }})
...
![The create drawer on the Select Instance Type step]({{ screenshot: template-instance-create-drawer }})
...
![The create drawer on the Basic Information step]({{ screenshot: template-instance-create-drawer-info }})
...
![The create drawer on the Parameters step]({{ screenshot: template-instance-create-drawer-params }})
...
![The YAML view of a Template Instance]({{ screenshot: template-instance-yaml-view }})
