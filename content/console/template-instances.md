...
{{ screenshot: template-instance-details }}
...
{{ screenshot: template-instance-create-drawer }}
...
{{ screenshot: template-instance-create-drawer-info }}
...
{{ screenshot: template-instance-create-drawer-params }}
...
{{ screenshot: template-instance-yaml-view }}
