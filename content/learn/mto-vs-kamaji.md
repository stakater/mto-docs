...
Kamaji hands a tenant a cluster. Everything that makes that cluster a governed platform is still to be built, and built again for each tenant cluster shared by more than one team:
