...
!!! tip
    Tenant users can use the [kubectl-tenant plugin](../cli/overview.md) to list cluster resources available to them, such as namespaces and storage classes: `kubectl tenant get namespaces bluesky`
