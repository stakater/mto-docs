...
!!! tip
    Tenant users can use the [kubectl-tenant plugin](../reference/cli.md) to list the PodPriorityClasses available to them: `kubectl tenant get priorityclasses <tenant-name>`
