...
1. What **tenant members** may do inside their namespaces, granted by roles MTO creates for each tenant from the [IntegrationConfig](../multi-tenancy/concepts/integration-config.md).
