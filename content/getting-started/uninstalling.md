...
For more details check out [onDeletePurgeNamespaces](../multi-tenancy/guides/delete-tenant.md#configuration-for-retaining-resources)
[onDeletePurgeAppProject](../extensions/concepts/extensions.md#per-tenant-extensions-the-extensions-cr)
...
* For more details on how to use MTO please refer [Tenant's tutorial](../multi-tenancy/guides/create-tenant.md).
* For more details on how to extend your MTO manager ClusterRole please refer [extend-default-clusterroles](../multi-tenancy/guides/extend-default-roles.md).
