...
!!! tip
    Tenant users can use the [kubectl-tenant plugin](../../cli/overview.md) to list the StorageClasses available to them: `kubectl tenant get storageclasses <tenant-name>`
