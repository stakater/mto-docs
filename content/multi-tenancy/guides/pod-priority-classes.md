...
!!! tip
    Tenant users can use the [kubectl-tenant plugin](../../cli/overview.md) to list the PodPriorityClasses available to them: `kubectl tenant get priorityclasses <tenant-name>`
